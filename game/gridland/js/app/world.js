define(['jquery', 'app/eventmanager', 'app/analytics', 'app/graphics/graphics', 'app/entity/building', 
	...
	var World = {
		...
		gameOver: function() {
			...
			$("#you_level").html(this.level);
			$("#you_dragonkill").html(GameState.counts['DRAGONS']);
			$("#you_prestige").html(this.prestige);
		},
	...
	function phaseTransition() {
		...
		if(!isNight) {
			...
			$('#Saveinfo').css("color","#000");
			
			if(casualNight) {
				GameState.count('CASUALNIGHTS', 1);
				//console.log('Wow! 跳過夜晚!');
			}
		} else {
